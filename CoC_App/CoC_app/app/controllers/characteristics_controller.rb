class CharacteristicsController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to characteristics_path, status: :see_other, notice: "Characteristic was successfully destroyed." }
  ...
  private
    ...
    def characteristic_params
      params.require(:characteristic).permit(:Strength, :Dexterity, :Constitution, :Appearance, :Power, :Luck, :Size, :Intelligence, :Education, :Character_id)
    end
end
